...
#' @return backbone graph: Binary or signed backbone graph. This function uses \link{class.convert} to output the graph as the same class as the data inputted in one of \link{sdsm}, \link{fdsm}, or \link{hyperg}.
#'
