...
#'     If "original", the backbone graph returned is of the same class as the data inputted in the original backbone null model.
...
#'     This object is returned by \link{sdsm}, \link{fdsm}, \link{fixedrow}, \link{fixedcol}.
