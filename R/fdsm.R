...
#'     If the dyad_parameter is indicated to be used in the parameters, when the B* matrix is projected (multiplied by its transpose), the projected value for the corresponding row and column will be saved.
