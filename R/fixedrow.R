...
fixedrow <- function(B, alpha = 0.05, signed = FALSE, mtc = "none", class = "original", narrative = FALSE){
  ...
  bb <- list(G = P, Pupper = Pupper, model = "fixedrow")  #Preliminary backbone object
