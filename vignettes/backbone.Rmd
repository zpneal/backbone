...
The function `universal()` returns a `backbone` object containing the backbone graph, with either signed (or binary) edge weights. The `universal()` function can be used in a variety of different ways, demonstrated in the following examples. 
