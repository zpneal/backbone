...
5. [Utility functions](#utility)
    ...
    b. [Bipartite network genetation](#generation)
    c. [Matrix randomization](#randomization)
    d. [Bipartite Configuration Model (BiCM)](#bicm)
...
B <- rbind(cbind(matrix(rbinom(250,1,.8),10),
           ...
           cbind(matrix(rbinom(250,1,.2),10),
                 matrix(rbinom(250,1,.2),10),
                 matrix(rbinom(250,1,.8),10)))
bb.object <- fdsm(B, trials = 1000)  #Backbone object containing edgewise p-values
```
